...
class wp_qrcode_gen extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
		<a href="<?php echo plugins_url()."/wp-qrcode-gen/"; ?>saveas.php?website=<?php bloginfo('name');?>&image_path=http://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php echo $url; ?>" target="_blank"><img src="http://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php echo $url; ?>" title="<?php echo $url; ?>" alt="QR: <?php echo $url; ?>" /></a>
		<br /><sub>(click on QR CODE to download)</sub> 
		<?php
		echo $after_widget;
	}
